...
const findMonitorsAndReceiverInRegistry = (
	...
	let arrAbsolutePosition = [absolutePosition, {...absolutePosition, y: absolutePosition.y - 30}, {...absolutePosition, y: absolutePosition.y + 30}, {...absolutePosition, x: absolutePosition.x - 30}, {...absolutePosition, x: absolutePosition.x + 30}];
	...
	registry.viewIds.forEach((targetId) => {
		...
		arrAbsolutePosition.forEach(absolutePosition => {
